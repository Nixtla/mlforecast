...
`audit_data` | <code>[bool](#bool)</code> | Run data quality audits before fitting. Warns about missing dates and duplicate rows. Defaults to False. | <code>False</code>
...
`weight_col` | <code>[str](#str)</code> | Column that contains the sample weights. Defaults to None. | <code>None</code>
`audit_data` | <code>[bool](#bool)</code> | Run data quality audits before preprocessing. Warns about missing dates and duplicate rows. Defaults to False. | <code>False</code>
...
`as_numpy` | <code>[bool](#bool)</code> | Cast features to numpy array. Defaults to False. | <code>False</code>
`weight_col` | <code>[str](#str)</code> | Column that contains the sample weights. Defaults to None. | <code>None</code>
`audit_data` | <code>[bool](#bool)</code> | Run data quality audits on the full dataset before cross-validation. Warns about missing dates and duplicate rows. Defaults to False. | <code>False</code>

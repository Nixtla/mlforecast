...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L32"
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L50"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L126"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L158"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
| n_seasons     | Optional | 10          | Number of seasons to use to determine the number of differences. Defaults to 10.<br/>If `None` will use all samples, otherwise `season_length` \* `n_seasons samples` will be used for the test.<br/>Smaller values will be faster but could be less accurate. |

------------------------------------------------------------------------

<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L187"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
| max_diffs         | int      |             | Maximum number of differences to apply.                                                                                                                                                                                                                          |
| n_seasons         | Optional | 10          | Number of seasons to use to determine the number of differences. Defaults to 10.<br/>If `None` will use all samples, otherwise `max_season_length` \* `n_seasons samples` will be used for the test.<br/>Smaller values will be faster but could be less accurate. |
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L257"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L265"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L271"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L284"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/target_transforms.py#L304"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>

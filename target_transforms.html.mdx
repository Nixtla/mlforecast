...
Type | Description
---- | -----------
<code>[ValueError](#ValueError)</code>| During fit_transform, if any series doesn't have enough data points. With n_seasons specified, each series must have at least `max_season_length * n_seasons` observations.

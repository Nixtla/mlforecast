...
Bases: <code>[_BaseDifferences](#mlforecast.target_transforms._BaseDifferences)</code>
...
#### `AutoSeasonalityAndDifferences.clone`
...
Name | Type | Description | Default
---- | ---- | ----------- | -------
`scale` | <code>[str](#str)</code> | Statistic to use for scaling. Can be either 'iqr' (Inter Quartile Range) or 'mad' (Median Absolute Deviation). Defaults to 'iqr'. | *required*

#### `LocalRobustScaler.clone`

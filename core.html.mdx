...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/core.py#L195"
...
The [`TimeSeries`](https://Nixtla.github.io/core.html#timeseries) class
takes care of defining the transformations to be performed (`lags`,
`lag_transforms` and `date_features`). The transformations can be
computed using multithreading if `num_threads > 1`.
...
[`_transform_series`](https://Nixtla.github.io/grouped_array.html#_transform_series)
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/core.py#L489"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
[`TimeSeries.fit_transform`](https://Nixtla.github.io/core.html#timeseries.fit_transform)
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/core.py#L694"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
[`TimeSeries.predict`](https://Nixtla.github.io/core.html#timeseries.predict)
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/core.py#L795"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>

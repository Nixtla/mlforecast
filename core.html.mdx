...
```python
history_warmup(df, id_col, time_col, target_col, static_features=None, keep_last_n=None, weight_col=None, max_horizon=None, horizons=None, as_numpy=None, trim=True, horizon_features=None)
```
...
`horizon_features` | <code>[Optional](#typing.Optional)[[Dict](#typing.Dict)[[int](#int), [List](#typing.List)[[str](#str)]]]</code> | Mapping of 1-indexed horizons to the dynamic exogenous columns each horizon's model uses. When None, any mapping from a previous fit is preserved. | <code>None</code>

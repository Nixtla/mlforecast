...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/core.py#L179"
...
``` text
/tmp/ipykernel_59897/2458559600.py:25: FutureWarning: The `window_ops` package (and thus `numba`) will no longer be a dependency in a future version.
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/core.py#L520"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/core.py#L767"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/core.py#L872"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>

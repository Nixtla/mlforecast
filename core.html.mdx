...
```python
TimeSeries(freq, lags=None, lag_transforms=None, date_features=None, num_threads=1, target_transforms=None, lag_transforms_namer=None, date_features_as_dummies=False, date_features_as_categorical=False, drop_auxiliary_columns=True)
```
...
```python
history_warmup(df, id_col, time_col, target_col, static_features=None, keep_last_n=None, weight_col=None, max_horizon=None, horizons=None, as_numpy=None, trim=True)
```

...
>                      num_samples:int, loss:Optional[Callable[[Union[pandas
>                      .core.frame.DataFrame,polars.dataframe.frame.DataFram
>                      e],Union[pandas.core.frame.DataFrame,polars.dataframe
>                      .frame.DataFrame]],float]]=None,
...
| optimize_kwargs | Optional           | None        | Keyword arguments to be passed to the Study.optimize method.                                                                         |
| **Returns**     | **AutoMLForecast** |             | **object with best models and optimization results**                                                                                 |

------------------------------------------------------------------------

<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/auto.py#L541"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/mlforecast/blob/main/mlforecast/auto.py#L569"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>

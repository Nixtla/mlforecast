...
>                   Union[int,numpy.random.mtrand.RandomState,ForwardRef('np
>                   .random.Generator'),NoneType]=None,
>                   n_jobs:Optional[int]=None, importance_type:str='split',
>                   **kwargs)
> ```

**PublicAPI (beta):** This API is in beta and may change before becoming
stable.

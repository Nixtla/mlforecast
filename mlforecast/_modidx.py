  ...
  'syms': { 'mlforecast.callbacks': { 'mlforecast.callbacks.SaveFeatures': ('callbacks.html#savefeatures', 'mlforecast/callbacks.py'),
            ...
            'mlforecast.lag_transforms': { 'mlforecast.lag_transforms.ExpandingMax': ( 'lag_transforms.html#expandingmax',
                                           ...
                                           'mlforecast.lag_transforms._RollingBase.__init__': ( 'lag_transforms.html#_rollingbase.__init__',
                                                                                                'mlforecast/lag_transforms.py'),
                                           'mlforecast.lag_transforms._RollingBase._set_core_tfm': ( 'lag_transforms.html#_rollingbase._set_core_tfm',
                                                                                                     'mlforecast/lag_transforms.py'),
                                           ...
                                           'mlforecast.lag_transforms._Seasonal_RollingBase.__init__': ( 'lag_transforms.html#_seasonal_rollingbase.__init__',
                                                                                                         'mlforecast/lag_transforms.py'),
                                           'mlforecast.lag_transforms._Seasonal_RollingBase._set_core_tfm': ( 'lag_transforms.html#_seasonal_rollingbase._set_core_tfm',
                                                                                                              'mlforecast/lag_transforms.py')},

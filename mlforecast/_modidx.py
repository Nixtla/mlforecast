  ...
  'syms': { 'mlforecast.callbacks': { 'mlforecast.callbacks.SaveFeatures': ('callbacks.html#savefeatures', 'mlforecast/callbacks.py'),
            ...
            'mlforecast.target_transforms': { 'mlforecast.target_transforms.AutoDifferences': ( 'target_transforms.html#autodifferences',
                                              ...
                                              'mlforecast.target_transforms.AutoSeasonalDifferences.__init__': ( 'target_transforms.html#autoseasonaldifferences.__init__',
                                                                                                                 'mlforecast/target_transforms.py'),
                                              'mlforecast.target_transforms.AutoSeasonalDifferences.update': ( 'target_transforms.html#autoseasonaldifferences.update',
                                                                                                               'mlforecast/target_transforms.py'),
                                              ...
                                              'mlforecast.target_transforms.AutoSeasonalityAndDifferences.__init__': ( 'target_transforms.html#autoseasonalityanddifferences.__init__',
                                                                                                                       'mlforecast/target_transforms.py'),
                                              'mlforecast.target_transforms.AutoSeasonalityAndDifferences.update': ( 'target_transforms.html#autoseasonalityanddifferences.update',
                                                                                                                     'mlforecast/target_transforms.py'),

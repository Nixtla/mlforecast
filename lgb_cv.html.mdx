...
`categorical_feature` | <code>list of str</code> | Names of the features that LightGBM should treat as categorical. These can be features generated by this object, e.g. date features such as 'dayofweek'. Defaults to None, which lets LightGBM infer them from the categorical dtypes of the input. | <code>None</code>

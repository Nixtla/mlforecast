...
[`MLForecast`](https://Nixtla.github.io/forecast.html#mlforecast). For a
minimal example visit the [Quick Start](quick_start_local.html)
...
The input to
[`MLForecast`](https://Nixtla.github.io/forecast.html#mlforecast) is a
data frame in [long
...
has been instantiated, we can use the [cross_validation

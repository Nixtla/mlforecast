...
> Start](https://nixtlaverse.nixtla.io/mlforecast/docs/getting-started/quick_start_local)
...
use. This implementation makes cross-validation a efficient operation,
...
MLForecast](https://nixtlaverse.nixtla.io/mlforecast/docs/getting-started/install)
...
```python
fig.savefig('../../figs/cross_validation__series.png', bbox_inches='tight')
```
...
documentation](https://nixtlaverse.nixtla.io/mlforecast) to see all
available features.

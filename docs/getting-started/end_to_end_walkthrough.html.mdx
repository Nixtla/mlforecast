...
![](/docs/getting-started/../../figs/end_to_end_walkthrough__eda.png)
...
![](/docs/getting-started/../../figs/end_to_end_walkthrough__differences.png)
...
![](/docs/getting-started/../../figs/end_to_end_walkthrough__predictions.png)
...
![](/docs/getting-started/../../figs/end_to_end_walkthrough__cv.png)
...
[`LightGBMCV`](https://Nixtla.github.io/lgb_cv.html#lightgbmcv) allows
us to train a few [LightGBM](https://github.com/microsoft/LightGBM)
models on different partitions of the data. The main differences with
[`MLForecast.cross_validation`](https://Nixtla.github.io/forecast.html#mlforecast.cross_validation)
are:
...
![](/docs/getting-started/../../figs/end_to_end_walkthrough__lgbcv.png)
...
from the [`LightGBMCV`](https://Nixtla.github.io/lgb_cv.html#lightgbmcv)
one as follows:
...
![](/docs/getting-started/../../figs/end_to_end_walkthrough__final_forecast.png)
